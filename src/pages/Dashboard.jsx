...
export default function Dashboard() {
  ...
  if (userType === "student") return studentDash;
        ...
        <div className="courses-container flex flex-col justify-around items-center">
          <div className="course-couple flex justify-around items-center">
            <div
              onClick={courseClickHandler}
              className={`course ${
                userData.course.includes(courses[0]) ? "text-green-600" : ""
              }`}
            >
              {courses[0]}
            </div>
            <div
              onClick={courseClickHandler}
              className={`course ${
                userData.course.includes(courses[1]) ? "text-green-600" : ""
              }`}
            >
              {courses[1]}
            </div>
          ...
          <div className="course-couple flex justify-around items-center">
            <div
              onClick={courseClickHandler}
              className={`course ${
                userData.course.includes(courses[2]) ? "text-green-600" : ""
              }`}
            >
              {courses[2]}
            </div>
  ...
  if (userType === "teacher") return teacherDash;
}
